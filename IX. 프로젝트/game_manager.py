...
class GameManager_GUI:
    def __init__(self):
        ...
        self.root.title("틱택토")
        self.root.geometry(str(CANVAS_SIZE)+"x"+str(CANVAS_SIZE))  #창 크기  300x300 으로 표시한거임
        self.root.resizable(width=False, height=False)   #창크기 변경 ㄴ ㄴ
    ...
    def click_handler(self,event):
        row = int(event.y//self.TITLE_SIZE)      #math.floor(event.y/self.TITLE_SIZE)
